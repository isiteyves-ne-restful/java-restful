package rw.rca.ne.isite.idm_server.serviceImpls;
...
import rw.rca.ne.isite.idm_server.exceptions.ResourceNotFoundException;
import rw.rca.ne.isite.idm_server.models.Website;
import rw.rca.ne.isite.idm_server.repositories.IWebsiteRepository;
...
public class WebsiteServiceImpl implements IWebsiteService {
    ...
    @Override
    public Website findById(Integer websiteId) {
